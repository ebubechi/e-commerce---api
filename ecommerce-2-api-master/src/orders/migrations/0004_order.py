    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.ForeignKey(related_name='billing_address', to='orders.UserAddress', on_delete= models.CASCADE)),
                ('cart', models.ForeignKey(to='carts.Cart', on_delete= models.CASCADE)),
                ('shipping_address', models.ForeignKey(related_name='shipping_address', to='orders.UserAddress', on_delete= models.CASCADE)),
